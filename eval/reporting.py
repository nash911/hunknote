...
def load_result(path: Path) -> EvalRunResult:
    ...
    for cd in data.get("cases", []):
        ...
        mechanical = MechanicalResult(
            ...
            hunk_coverage=mech_data.get("hunk_coverage"),
            missing_hunk_ids=mech_data.get("missing_hunk_ids"),
            hallucinated_hunk_ids=mech_data.get("hallucinated_hunk_ids"),
    ...
    for case in result.cases:
        ...
        cases_data.append({
            ...
            "mechanical": {
                ...
                "hunk_coverage": case.mechanical.hunk_coverage,
                "missing_hunk_ids": case.mechanical.missing_hunk_ids,
                "hallucinated_hunk_ids": case.mechanical.hallucinated_hunk_ids,
