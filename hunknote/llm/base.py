...
When type="merge":
- Subject should describe what is being merged (e.g., "Merge feature-branch into main")
- Body bullets should summarize the key changes being merged
- Scope can indicate the primary area affected by the merge
...
When type="merge":
- Title should describe what is being merged (e.g., "Merge feature-branch into main")
