"""User configuration management for aicommit.

Handles reading and writing the .aicommit/config.yaml file in each repository.
"""
...
def get_config_file(repo_root: Path) -> Path:
    ...
    """
    config_dir = repo_root / ".aicommit"
    config_dir.mkdir(exist_ok=True)
    return config_dir / "config.yaml"


def load_config(repo_root: Path) -> dict:
    """Load the aicommit configuration from config.yaml.
