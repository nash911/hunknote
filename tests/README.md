...
This test suite contains **455 unit tests** covering all modules of the hunknote project. The tests use `pytest` and `pytest-mock` for mocking external dependencies.
...
├── test_git_ctx.py         # Git context tests (44 tests)
